...
`sqlr.[INSERT THE NAME OF THE PACKAGE]` is an R package with the research compendium of the project: `[INSERT THE NAME OF THE PROJECT]`: A Systematic Quantitative Literature Review. The aim of `sqlr.[INSERT THE NAME OF THE PACKAGE]` is to facilitate the research work, in addition to contributing to the reproducibility of the research.
...
Learn more about Systematic Quantitative Literature Reviewss at <http://bit.ly/2OMxvcD>.
